...
export const useChangeOwnerAction = (user: Pick<IUser, '_id' | 'username' | 'name'>, rid: IRoom['_id']): UserInfoAction | undefined => {
	...
	const changeOwner = useEndpointAction('POST', `${endpointPrefix}.${changeOwnerEndpoint}`, {
		successMessage: t(changeOwnerMessage, { name: user.name, room_name: roomName }),
	});
