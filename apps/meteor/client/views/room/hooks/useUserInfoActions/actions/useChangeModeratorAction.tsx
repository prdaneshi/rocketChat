...
export const useChangeModeratorAction = (user: Pick<IUser, '_id' | 'username'| 'name'>, rid: IRoom['_id']): UserInfoAction | undefined => {
	...
	const changeModerator = useEndpointAction('POST', `${endpointPrefix}.${changeModeratorEndpoint}`, {
		successMessage: t(changeModeratorMessage, { name: user.name, room_name: roomName }),
	});
