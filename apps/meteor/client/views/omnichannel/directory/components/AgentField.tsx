	...
	return (
		<Field>
			...
			<Info style={{ display: 'flex' }}>
				<UserAvatar size={isSmall ? 'x28' : 'x40'} title={name} username={username || ''} />
				<AgentInfoDetails mis={isSmall ? 'x8' : 'x10'} name={displayName} shortName={name} status={<UserStatus status={status} />} />
			</Info>
		</Field>
	);
};
