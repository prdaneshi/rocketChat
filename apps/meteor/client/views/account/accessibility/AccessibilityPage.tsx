				...
				<Box is='form' id={pageFormId} onSubmit={handleSubmit(handleSaveData)} maxWidth='x600' w='full' alignSelf='center' mb={40} mi={36}>
					<Box fontScale='p1' mbe={24}>
						...
						<ul aria-labelledby={linkListId}>
							<li>
								<ExternalLink to='https://sina.co/i/accessibility-statement'>{t('Accessibility_statement')}</ExternalLink>
							</li>
							<li>
								<ExternalLink to='https://sina.co/i/glossary'>{t('Glossary_of_simplified_terms')}</ExternalLink>
							</li>
							<li>
								<ExternalLink to='https://sina.co/i/accessibility-and-appearance'>
